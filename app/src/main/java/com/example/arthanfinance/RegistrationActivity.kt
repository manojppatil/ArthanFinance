...
class RegistrationActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mobileNoText.addTextChangedListener(textWatcher)

        btnSubmit = findViewById(R.id.btn_submit)
        btnSubmit.setOnClickListener{
            if(nameText.text.isNotEmpty() && mobileNoText.text.isNotEmpty() && dobText.text.isNotEmpty() && emailText.text.isNotEmpty()) {
                ...
                if(!isValidMail(emailText.text.toString())) {
    ...
    private fun registerCustomerData() {
        ...
        apiClient.getApiService(this).registerCustomer(jsonObject).enqueue(object :
